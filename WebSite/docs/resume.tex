...
\begin{enumerate}[]
	...
	\item \textit{Co-Founder, CTO} \textbf{\href{https://dotmos.com}{dotmos, LLC.}} \hfill July 2015 - Present\\
		...
		\begin{enumerate}[*]
			...
			\item \textbf{Lead Software Engineer:} front-end and back-end design and development.
			\item \textbf{Project Management:} development team leader, repository management, issue curation, documentation generation, team communications, and data analysis.
		\end{enumerate}
	\item \textit{Data Scientist, Software Engineer, etc.} \textbf{\href{https://upstreamresearch.com}{Upstream Research, Inc.}} \hfill November 2015 - September 2016\\
		...
		\begin{enumerate}[*]
			...
			\item \textbf{System Administration:} deploying software releases, ensuring server up-time complied with SLA, security updates and patches, and managing Azure resources.
			\item \textbf{Customer Support:} interfacing directly with customers and debugging customer and software issues.
		\end{enumerate}
...
\begin{enumerate}[]
	...
	\item \textbf{Tools:} Android SDK, DeployBot, Emacs, GIT, Mercurial, SublimeText, VIM, Visual Studio
